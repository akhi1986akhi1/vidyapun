...
@Component({
  selector: 'app-nonteachingform',
  templateUrl: './nonteachingform.component.html',
  styleUrls: ['./nonteachingform.component.scss']
})
export class NonTeachingFormComponent implements OnInit {
